...
int main() {
    ...
    do {
        ...
        case 7:
            ...
            cout << "\n";
            cout << "========== TOTAL BILLING COST ==========\n";

            if (facilityALoaded) {
                facilityA.displayTotalBillingCost("FACILITY A");
            }

            if (facilityBLoaded) {
                facilityB.displayTotalBillingCost("FACILITY B");
            }

            if (facilityCLoaded) {
                facilityC.displayTotalBillingCost("FACILITY C");
            }
        ...
        case 8:
            ...
            if (facilityALoaded) {
                facilityA.displayDatasetSummary("FACILITY A");
            }

            if (facilityBLoaded) {
                facilityB.displayDatasetSummary("FACILITY B");
            }

            if (facilityCLoaded) {
                facilityC.displayDatasetSummary("FACILITY C");
            }
